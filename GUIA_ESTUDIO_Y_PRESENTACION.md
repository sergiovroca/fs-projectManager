...
Y `.env`:
```
DATABASE_URL="postgresql://postgres:***CLAVE-ROTADA***@localhost:5435/taskmanager"
JWT_SECRET="***JWT-ROTADO***"
```
- `postgres` = usuario, `***CLAVE-ROTADA***` = contraseña, `localhost:5435` = host:puerto, `taskmanager` = base.
